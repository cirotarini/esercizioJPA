import { __decorate, __assign, __metadata, __param, __values, __extends, __spread } from 'tslib';
import { ɵɵdefineInjectable, Injectable, ɵɵinject, Input, Component, Directive, forwardRef, EventEmitter, Output, ContentChild, HostListener, Host, Optional, ElementRef, Pipe, NgModule, SecurityContext, Sanitizer } from '@angular/core';
...
var JhiAlertService = /** @class */ (function () {
    ...
    JhiAlertService.ngInjectableDef = ɵɵdefineInjectable({ factory: function JhiAlertService_Factory() { return new JhiAlertService(ɵɵinject(Sanitizer), ɵɵinject(JhiConfigService), ɵɵinject(TranslateService, 8)); }, token: JhiAlertService, providedIn: "root" });
    JhiAlertService = __decorate([
        Injectable({
            providedIn: 'root'
        }),
        __param(2, Optional()),
        __metadata("design:paramtypes", [Sanitizer,
            JhiConfigService,
            TranslateService])
    ], JhiAlertService);
