...
import it.plan.eserciziojpa.config.audit.AuditEventConverter;
import it.plan.eserciziojpa.domain.PersistentAuditEvent;
...
import static it.plan.eserciziojpa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
